  ...
  render(){    
    ...
    <header class="app-header">
      ...
      <nav class="app-top-nav">
        ...
        <a href="/newPetminder" @click="${anchorRoute}">Add Petminder</a>
        ` : ``}
    ...
    <sl-drawer class="app-side-menu" placement="left">
      ...
      <nav class="app-side-menu-items">
        ...
        ${this.user.accessLevel == 2 ? html`
        <a href="/newPetminder" @click="${this.menuClick}">Add Petminder</a>
        ` : ``}
        <a href="/petminders" @click="${this.menuClick}">Pet Minders</a>
        <a href="/petowners" @click="${this.menuClick}">Pet Owners</a>
        <a href="/favouritePetminders" @click="${this.menuClick}">Favourite Petminders</a>
