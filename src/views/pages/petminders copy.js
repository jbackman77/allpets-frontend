...
class PetmindersView {
  ...
  render(){
    ...
    <va-app-header title="Pet Minders" user="${JSON.stringify(Auth.currentUser)}"></va-app-header>
      ...
      </sl-button class="filter-btn" size="small" data-field="Animal" data-match="ld" @click=${this.handleFilterBtn.bind(this)}>LgDog</sl-button>
      </sl-button  class="filter-btn" size="small" data-field="Animal" data-match="sd" @click=${this.handleFilterBtn.bind(this)}>SmDog</sl-button>
      </sl-button  class="filter-btn" size="small" data-field="Animal" data-match="sd" @click=${this.handleFilterBtn.bind(this)}>cat</sl-button>
      </sl-button  class="filter-btn" size="small" data-field="Animal" data-match="sd" @click=${this.handleFilterBtn.bind(this)}>LgAml</sl-button>
      </sl-button  class="filter-btn" size="small" data-field="Animal" data-match="sd" @click=${this.handleFilterBtn.bind(this)}>SmlAml</sl-button>
