...
class UserAPI {
  ...
  async addFavPetminder(petminderId) {
    // validate
    if (!petminderId) return; // fetch the json data

    const response = await fetch("".concat(_App.default.apiBase, "/user/addFavPetminder"), {
      method: "PUT",
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken),
        "Content-Type": 'application/json'
    ...
    if (!response.ok) {
      ...
      throw new Error('Problem adding petminder to favourites');
    } // convert response payload into json - store as data
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","../../Toast":"Toast.js"}],"PetminderAPI.js":[function(require,module,exports) {
"use strict";
...
class PetminderAPI {
  async newPetminder(formData) {
    // send fetch request
    const response = await fetch("".concat(_App.default.apiBase, "/petminder"), {
      method: 'POST',
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      },
    ...
    if (!response.ok) {
      let message = 'Problem adding petminder';
  ...
  async getPetminders() {
    ...
    if (!response.ok) {
      ...
      throw new Error('Problem getting Pet Minders');
    } // convert response payload into json - store as data
...
var _default = new PetminderAPI();

exports.default = _default;
},{"./App":"App.js","./Auth":"Auth.js","./Toast":"Toast.js"}],"views/pages/petminders.js":[function(require,module,exports) {
"use strict";
...
var _PetminderAPI = _interopRequireDefault(require("../../PetminderAPI"));
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n    <style>\n    .filter-menu {\n      display:flex;\n      align-items: center;\n    }\n\n    .filter-menu > div {\n      margin-right: 1em;\n    }\n    </style>\n\n    <va-app-header title=\"Pet Minders\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\"> \n\n       \n  \n\n      <div class=\"petminders-grid\">\n        ", "\n        </div>\n        \n      </div>      \n    "]);
...
class PetmindersView {
  async init() {
    ...
    await this.getPetminders(); //this.filterPetminders('animal', 'ld')
  }

  async filterPetminders(field, match) {
    //validate
    if (!field || !match) return; //get frsh copy of petminders

    this.petminders = await _PetminderAPI.default.getPetminders();
    let filteredPetminders; //animal field
  ...
  handleFilterBtn(e) {
    ...
    this.clearFiltersBtns(); //set button active (type=primary)

    e.target.setAttribute("type", "primary"); //extract the field and match from button

    const field = e.target.getAttribute("data-field");
    const match = e.target.getAttribute("data-match"); //filter petminders
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.petminders == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.petminders.map(petminder => (0, _litHtml.html)(_templateObject4(), petminder._id, petminder.name, petminder.description, JSON.stringify(petminder.user), petminder.image, petminder.animal, petminder.contact))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new PetmindersView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../PetminderAPI":"PetminderAPI.js","../../Toast":"Toast.js"}],"views/pages/petowners.js":[function(require,module,exports) {
"use strict";
...
var _default = new PetownersView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js"}],"views/pages/newPetminder.js":[function(require,module,exports) {
"use strict";
...
class newPetminderView {
  ...
  async newPetminderSubmitHandler(e) {
    ...
    try {
      await _PetminderAPI.default.newPetminder(formData);

      _Toast.default.show('Petminder added!');
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.newPetminderSubmitHandler, _Auth.default.currentUser._id);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new newPetminderView();

exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../PetminderAPI":"PetminderAPI.js","../../Toast":"Toast.js"}],"views/pages/favouritePetminders.js":[function(require,module,exports) {
"use strict";
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <va-app-header title=\"Favourite Petminders\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">    \n\n        <h1>Favourite Petminders</h1>\n\n        <div class=\"haircuts-grid\">\n        ", "\n        </div> \n        \n      </div>      \n    "]);
...
class favouritePetmindersView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.favPetminders == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.favPetminders.map(petminder => (0, _litHtml.html)(_templateObject4(), petminder._id, petminder.name, petminder.description, JSON.stringify(petminder.user), petminder.image, petminder.animal, petminder.contact))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new favouritePetmindersView();
...
var _petminders = _interopRequireDefault(require("./views/pages/petminders"));

var _petowners = _interopRequireDefault(require("./views/pages/petowners"));

var _newPetminder = _interopRequireDefault(require("./views/pages/newPetminder"));

var _favouritePetminders = _interopRequireDefault(require("./views/pages/favouritePetminders"));
...
const routes = {
  ...
  '/petminders': _petminders.default,
  '/petowners': _petowners.default,
  '/newPetminder': _newPetminder.default,
  '/favouritePetminder': _favouritePetminders.default
};
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/profile":"views/pages/profile.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/guide":"views/pages/guide.js","./views/pages/petminders":"views/pages/petminders.js","./views/pages/petowners":"views/pages/petowners.js","./views/pages/newPetminder":"views/pages/newPetminder.js","./views/pages/favouritePetminders":"views/pages/favouritePetminders.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
function _templateObject4() {
  const data = _taggedTemplateLiteral(["\n        <a href=\"/newPetminder\" @click=\"", "\">Add Petminder</a>\n        "]);
...
customElements.define('va-allpets', class Allpets extends _litElement.LitElement {
  constructor() {
    super();
  }
  ...
  moreInfoHandler() {
    ...
    dialogEl.className = 'petminders-dialog'; //sl-dialog content 

    const dialogContent = (0, _litElement.html)(_templateObject(), _App.default.apiBase, this.image, this.image, this.name, this.description, this.animal, this.addFavHandler.bind(this));
    (0, _litHtml.render)(dialogContent, dialogEl); //appent to document.body
  ...
  async addFavHandler() {
    try {
      _UserAPI.default.addFavPetminder(this.id);

      _Toast.default.show('Petminder added to favourites');
    } catch (err) {
      _Toast.default.show(err, 'error');
    }
  }
  ...
  render() {
    return (0, _litElement.html)(_templateObject2(), _App.default.apiBase, this.image, this.name, this.user.firstName, this.user.lastName, this.moreInfoHandler.bind(this), this.addFavHandler.bind(this));
  }
...
},{"./App.js":"App.js","./components/va-app-header":"components/va-app-header.js","./components/va-allpets":"components/va-allpets.js","./scss/master.scss":"scss/master.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
